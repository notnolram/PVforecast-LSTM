...
# Carregar os dados
dataset = pd.read_csv(
    'data/Usina/dados_consolidados_2024_2025.csv'
)
...
generation = dataset['Generation(kWh)']
...
WINDOW_SIZE = 30
X, Y = dataset_to_X_Y(generation, WINDOW_SIZE)

# Dividir em treino, validação e teste
X_train, Y_train = X[:600], Y[:600]
X_val, Y_val = X[600:665], Y[600:665]
X_test, Y_test = X[665:], Y[665:]
